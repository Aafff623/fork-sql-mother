...
## 背景故事
threetwoa是一位技术博主，他在各个平台都有发布内容。最近他发现自己的流量忽高忽低，摸不着头脑。作为他的数据分析助手，你需要帮他找出流量密码，看看到底什么内容最受粉丝欢迎！

## 数据说明
我们有一个内容发布表 `content_posts`，记录了threetwoa在各平台的发布情况：
...
## 任务要求
threetwoa想要了解他的创作数据表现，请你编写SQL查询：
